...
function Register() {
    ...
    return (
        <div className="">
                    ...
                    <div className="border grid w-[97%]  shadow-lg bg-white  rounded md:w-[27%] pb-4 mx-auto h-[80%] text-black">
                        ...
                        <div className="grid  items-center">
                            <div className="flex mt-4 justify-between w-[80%] mx-auto">
                                <p className="text-[0.70rem] mt-3">Don't you have an account ? </p>
                                <Link to="/Login">
                                    <p className="text-[#291E46] mt-3 hover:font-bold hover:text-black">
                                        Register
                                    </p>
                                </Link>
                            </div>
            ...
            <div className="w-[100%] mt-[25vh] h-[30vh]">
                <Footer />
            </div>
        </div>
    )
